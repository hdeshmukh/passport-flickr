...
function Strategy(options, verify) {
  ...
  options.userAuthorizationURL = options.userAuthorizationURL || 'https://www.flickr.com/services/oauth/authorize?perms=write';
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
    try {
      ...
      profile.id = params['user_nsid'].replace("@", "_");
